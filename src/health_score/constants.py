...
REMARK_TEMPLATES: Dict[str, Dict[str, str]] = {
    "profitability": {
        "excellent": "Strong profitability with excellent margins and returns on capital",
        "good": "Healthy profitability with good margin retention",
        "moderate": "Moderate profitability with average margin profile",
        "weak": "Weak profitability with declining margins",
        "poor": "Poor profitability with significant losses and negative returns",
    },
    "growth": {
        "excellent": "Exceptional revenue and earnings growth trajectory",
        "good": "Strong growth momentum in revenue and earnings",
        "moderate": "Moderate growth with stable expansion",
        "weak": "Weak growth trends with flat or declining revenues",
        "negative": "Negative growth trend with declining operations and earnings",
    },
    "cashflow": {
        "excellent": "Excellent cash generation with strong free cash flow and capital allocation",
        "good": "Strong cash flow generation with healthy conversion ratios",
        "moderate": "Adequate cash flow with reasonable conversion",
        "weak": "Weak cash generation with poor conversion ratios",
        "poor": "Poor cash generation raising liquidity concerns",
    },
    "leverage": {
        "low": "Low leverage with strong debt servicing capacity and conservative capital structure",
        "moderate": "Manageable debt levels with adequate interest coverage",
        "high": "High leverage risk with elevated debt burden and reduced financial flexibility",
        "very_high": "Very high leverage posing significant financial risk and distress potential",
        "critical": "Critical leverage levels with negative equity and solvency concerns",
    },
    "efficiency": {
        "excellent": "Excellent asset utilization with high operational efficiency",
        "good": "Strong asset turnover indicating efficient operations",
        "moderate": "Adequate asset utilization with room for improvement",
        "weak": "Weak asset utilization indicating operational inefficiencies",
        "poor": "Poor asset utilization with significant efficiency concerns",
    },
}
