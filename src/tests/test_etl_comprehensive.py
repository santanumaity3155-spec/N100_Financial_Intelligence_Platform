...
class TestDataValidator(unittest.TestCase):
    ...
    def test_validate_required_columns_missing(self):
        ...
        df = pd.DataFrame({"company_id": ["TCS", "INFY"], "sales": [1000.0, 2000.0]})
    ...
    def test_detect_missing_values_with_missing(self):
        ...
        result = self.validator.detect_missing_values(
            df, "test_dataset", threshold=50.0
        )
    ...
    def test_validate_data_types_mismatch(self):
        ...
        df = pd.DataFrame(
            {"id": ["1", "2", "3"], "value": [1.0, 2.0, 3.0]}  # String instead of int
        )
...
class TestDataNormalizer(unittest.TestCase):
    ...
    def test_normalize_dataframe(self):
        ...
        result = self.normalizer.normalize_dataframe(
            df=df, company_id_col="company_id", date_cols=[], numeric_cols=["sales"]
        )
    ...
    def test_remove_duplicates(self):
        ...
        result = self.normalizer.remove_duplicates(df, subset=["company_id", "period"])
...
class TestDatabaseOperations(unittest.TestCase):
    ...
    def test_foreign_key_check_violations(self):
        ...
        self.cursor.execute(
            "INSERT INTO profit_loss VALUES (1, 'NONEXISTENT', '2024-Q1')"
        )
        self.conn.commit()
    ...
    def test_duplicate_records_check(self):
        ...
        self.cursor.execute("INSERT INTO profit_loss VALUES (1, 'TCS', '2024-Q1')")
        self.cursor.execute(
            "INSERT INTO profit_loss VALUES (2, 'TCS', '2024-Q1')"
        )  # Duplicate
...
class TestEdgeCases(unittest.TestCase):
    ...
    def test_none_values_handling(self):
        ...
        df = pd.DataFrame(
            {"company_id": ["TCS", None, "WIPRO"], "sales": [1000.0, None, 3000.0]}
        )
    ...
    def test_special_characters_in_company_id(self):
        ...
        test_ids = ["TCS-123", "INFY & CO", "WIPRO@2024", "HDFC$BANK"]
    ...
    def test_null_threshold_by_dataset(self):
        ...
        result = validator.validate_dataset(
            df_companies, "companies", required_columns=["company_id"]
        )
        ...
        df_pros_cons = pd.DataFrame(
            {"company_id": ["TCS", "INFY", "WIPRO"], "pros": ["A", None, "C"]}
        )
        result = validator.validate_dataset(
            df_pros_cons, "pros_cons", required_columns=["company_id"]
        )
...
class TestConvenienceFunctions(unittest.TestCase):
    ...
    def test_validate_dataset_function(self):
        ...
        result = validate_dataset(df, "test_dataset", required_columns=["id", "name"])
