...
class KPIFormatter:
    ...
    def kpi_results_to_json(
        self, kpi_batch: List[Dict[str, Any]], indent: int = 2
    ) -> str:
        """
    ...
    def save_kpi_results_to_json(
        self, kpi_batch: List[Dict[str, Any]], file_path: str
    ) -> bool:
        """
    ...
    def get_kpi_statistics(self, kpi_batch: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        stats = {"total_companies": len(df), "kpi_statistics": {}}
