...
class ProfitabilityCalculator:
    ...
    def calculate_all(self, company_id: str, period: str) -> Dict[str, Any]:
        ...
        logger.info(
            f"Calculated {len([v for v in results.values() if v is not None])} profitability KPIs"
        )
        return results
    ...
    def calculate_roce(
        ...
        try:
            ...
            if (
                ...
                logger.warning(
                    "ROCE calculation: Missing operating_profit or total_assets data"
                )
                return None

            # Calculate EBIT
            ebit = operating_profit + (
                interest if interest and not pd.isna(interest) else 0
            )
    ...
    def calculate_roa(
        ...
        try:
            ...
            logger.error(
                f"ROA calculation failed - IndexError (empty dataframe): {str(e)}"
            )
            return None
        except Exception as e:
    ...
    def calculate_net_profit_margin(self, pl_data: pd.DataFrame) -> Optional[float]:
        ...
        try:
            ...
            if pl_data.empty:
                logger.warning(
                    "Net Profit Margin calculation: Empty dataframe provided"
                )
                return None
            ...
            if (
                ...
                logger.warning(
                    "Net Profit Margin calculation: Missing net_profit or sales data"
                )
                return None
            ...
            logger.error(
                f"Net Profit Margin calculation failed - IndexError (empty dataframe): {str(e)}"
            )
            return None
        except Exception as e:
    ...
    def calculate_operating_margin(self, pl_data: pd.DataFrame) -> Optional[float]:
        ...
        try:
            ...
            if (
                ...
                logger.warning(
                    "Operating Margin calculation: Missing operating_profit or sales data"
                )
                return None
            ...
            logger.error(
                f"Operating Margin calculation failed - IndexError (empty dataframe): {str(e)}"
            )
            return None
        except Exception as e:
    ...
    def calculate_ebit_margin(self, pl_data: pd.DataFrame) -> Optional[float]:
        ...
        try:
            ...
            logger.error(
                f"EBIT Margin calculation failed - IndexError (empty dataframe): {str(e)}"
            )
            return None
        except Exception as e:
    ...
    def calculate_gross_margin(self, pl_data: pd.DataFrame) -> Optional[float]:
        ...
        try:
            ...
            if gross_profit is None or (
                hasattr(gross_profit, "isna") and gross_profit.isna().all()
            ):
            ...
            if (
                ...
                and hasattr(gross_profit, "iloc")
                and len(gross_profit) > 0
            ):
            ...
            if (
                ...
                or sales is None
                or pd.isna(gross_profit)
                or pd.isna(sales)
            ):
                logger.warning(
                    "Gross Margin calculation: Missing gross_profit or sales data"
                )
                return None
            ...
            logger.error(
                f"Gross Margin calculation failed - IndexError (empty dataframe): {str(e)}"
            )
            return None
        except Exception as e:
