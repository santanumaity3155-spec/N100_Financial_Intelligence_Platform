...
class DataNormalizer:
    ...
    def normalize_company_id(
        self, df: pd.DataFrame, company_id_column: str = "company_id"
    ) -> pd.DataFrame:
        """
    ...
    def normalize_dates(
        self, df: pd.DataFrame, date_columns: List[str], date_format: str = "%Y-%m-%d"
    ) -> pd.DataFrame:
        """
...
if __name__ == "__main__":
    ...
    df_normalized = normalizer.remove_duplicates(
        df_normalized, subset=["company_id", "date"]
    )
