    ...
    return pd.DataFrame(
        {
            ...
            * 3,
            "metric_value": [45.2, 48.3, 20.5, 0.2, 10000, 10.5, 12.3, 11.2, 15.5, 1.2]
            * 3,
            "percentile_rank": [
                0.85,
                0.82,
...
class TestFinancialRatiosValidation:
    ...
    @patch("src.validation.final_validation.get_connection")
    def test_validate_financial_ratios_success(
        self, mock_get_conn, mock_db_connection, sample_financial_ratios_df
    ):
        ...
        with patch(
            "src.validation.final_validation.pd.read_sql_query",
    ...
    @patch("src.validation.final_validation.get_connection")
    def test_validate_financial_ratios_empty_table(
    ...
    @patch("src.validation.final_validation.get_connection")
    def test_validate_financial_ratios_missing_kpis(
        self, mock_get_conn, mock_db_connection
    ):
        ...
        with patch(
            "src.validation.final_validation.pd.read_sql_query", return_value=df
        ):
            result = validate_financial_ratios()
...
class TestCAGRValidation:
    ...
    @patch("src.validation.final_validation.get_connection")
    def test_validate_cagr_success(
        self, mock_get_conn, mock_db_connection, sample_financial_ratios_df
    ):
...
class TestHealthScoreValidation:
    ...
    @patch("src.validation.final_validation.get_connection")
    def test_validate_health_scores_success(
        self, mock_get_conn, mock_db_connection, sample_health_scores_df
    ):
    ...
    @patch("src.validation.final_validation.get_connection")
    def test_validate_health_scores_empty_table(
        self, mock_get_conn, mock_db_connection
    ):
    ...
    @patch("src.validation.final_validation.get_connection")
    def test_validate_health_scores_out_of_range(
        self, mock_get_conn, mock_db_connection
    ):
...
class TestScreenerValidation:
    ...
    def test_validate_screeners_success(self, mock_list_presets, mock_screener_class):
        ...
        mock_engine.load_data.return_value = pd.DataFrame(
            {"company_id": ["TCS", "RELIANCE"]}
        )
    ...
    @patch("src.screener.engine.ScreenerEngine")
    @patch("src.validation.final_validation.list_preset_screeners")
    def test_validate_screeners_import_failure(
        self, mock_list_presets, mock_screener_class
    ):
...
class TestPeerRankingValidation:
    ...
    @patch("src.validation.final_validation.get_connection")
    def test_validate_peer_rankings_success(
        self, mock_get_conn, mock_db_connection, sample_peer_percentiles_df
    ):
...
class TestRadarChartValidation:
    ...
    @patch("src.validation.final_validation.get_connection")
    def test_validate_radar_charts_success(
        self, mock_get_conn, mock_output_dir, temp_dir
    ):
...
class TestRunFinalValidation:
    ...
    def test_run_final_validation_success(
        self,
        mock_validate_db,
        mock_validate_ratios,
        mock_validate_cagr,
        mock_validate_health,
        mock_validate_screener,
        mock_validate_peer,
        mock_validate_radar,
        mock_validate_reports,
    ):
