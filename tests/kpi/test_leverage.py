...
class TestDebtToEquity:
    ...
    def test_normal_calculation(self):
        ...
        bs_data = pd.DataFrame(
            {"borrowings": [10000], "equity_capital": [5000], "reserves": [5000]}
        )
    ...
    def test_borrowings_zero_returns_zero(self):
        ...
        bs_data = pd.DataFrame(
            {"borrowings": [0], "equity_capital": [5000], "reserves": [5000]}
        )
        ratio, flag = calculate_debt_to_equity(bs_data)
        assert ratio == 0.0
        assert flag is False
    ...
    def test_high_leverage_flag_non_financials(self):
        ...
        bs_data = pd.DataFrame(
            {"borrowings": [60000], "equity_capital": [5000], "reserves": [5000]}
        )
    ...
    def test_negative_equity_returns_none(self):
        ...
        bs_data = pd.DataFrame(
            {"borrowings": [10000], "equity_capital": [-5000], "reserves": [0]}
        )
        ratio, flag = calculate_debt_to_equity(bs_data)
    ...
    def test_zero_equity_returns_none(self):
        ...
        bs_data = pd.DataFrame(
            {"borrowings": [10000], "equity_capital": [0], "reserves": [0]}
        )
        ratio, flag = calculate_debt_to_equity(bs_data)
        assert ratio is None
        assert flag is False
...
class TestInterestCoverage:
    ...
    def test_normal_calculation(self):
        ...
        pl_data = pd.DataFrame(
            {"operating_profit": [5000], "other_income": [500], "interest": [1000]}
        )
        # EBIT = 5000 + 500 = 5500
    ...
    def test_interest_zero_debt_free(self):
        ...
        pl_data = pd.DataFrame(
            {"operating_profit": [5000], "other_income": [500], "interest": [0]}
        )
        coverage, label, warning = calculate_interest_coverage(pl_data)
    ...
    def test_icr_below_threshold_warning(self):
        ...
        pl_data = pd.DataFrame(
            {"operating_profit": [1000], "other_income": [100], "interest": [1000]}
        )
        # EBIT = 1000 + 100 = 1100
    ...
    def test_icr_above_threshold_no_warning(self):
        ...
        pl_data = pd.DataFrame(
            {"operating_profit": [2000], "other_income": [500], "interest": [1000]}
        )
        # EBIT = 2000 + 500 = 2500
