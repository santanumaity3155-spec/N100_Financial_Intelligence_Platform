...
class TestValidateReport:
    ...
    def test_validate_missing_company_info(self, sample_report_data):
        ...
        assert any("Company information is missing" in str(e) for e in results["errors"])
...
class TestSaveReport:
    ...
    def test_save_report_success(self, temp_output_dir):
        ...
        report_path = save_report(report_content, company_id, output_dir=temp_output_dir)
